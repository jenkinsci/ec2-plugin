...
class HostKeyTest {
    ...
    private static final String PUBLIC_KEY_SSH_DSS_1024 =
    ...
    private static final String PUBLIC_KEY_SSH_RSA_1024 =
    ...
    private static final String PUBLIC_KEY_SSH_RSA_2048 =
    ...
    private static final String PUBLIC_KEY_SSH_RSA_3072 =
    ...
    private static final String PUBLIC_KEY_SSH_RSA_4096 =
    ...
    private static final String PUBLIC_KEY_ECDSA_SHA2_NISTP256_256 =
    ...
    private static final String PUBLIC_KEY_ECDSA_SHA2_NISTP384_384 =
    ...
    private static final String PUBLIC_KEY_ECDSA_SHA2_NISTP521_521 =
    ...
    @ParameterizedTest
    @MethodSource("data")
    void testPublicKeyValidation(String description, String algorithm, String publicKey, String expected) {
        String fingerprint = new HostKey(algorithm, Base64.getDecoder().decode(publicKey)).getFingerprint();
        assertEquals(expected, fingerprint, description);
    }
}
