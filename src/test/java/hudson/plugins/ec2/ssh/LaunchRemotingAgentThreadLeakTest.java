...
class LaunchRemotingAgentThreadLeakTest {
    ...
    @Test
    void sessionIsClosed_whenConnectToSshThrows() throws Exception {
    ...
    @Test
    void sessionIsClosed_whenCreateExecChannelThrows() throws Exception {
        EC2WindowsSSHLauncher launcher = spy(new EC2WindowsSSHLauncher());
        doReturn(mockClientSession).when(launcher).connectToSsh(any(), any(), any());
    ...
    @Test
    void sharedClientIsNeverClosed_whenLaunchSucceeds() throws Exception {
        EC2WindowsSSHLauncher launcher = spy(new EC2WindowsSSHLauncher());
