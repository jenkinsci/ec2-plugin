...
public class SshHostKeyVerificationStrategyTest {
    ...
    private static class MockEC2Computer extends EC2Computer {
        ...
        private static MockEC2Computer createComputer(String suffix) throws Exception {
            final EC2AbstractSlave slave = new EC2AbstractSlave(COMPUTER_NAME + suffix, "id" + suffix, "description" + suffix, "fs", 1, null, "label", null, null, "init", "tmpDir", new ArrayList<NodeProperty<?>>(), "remote", "jvm", false, "idle", null, "cloud", Integer.MAX_VALUE, null, ConnectionStrategy.PRIVATE_IP, -1,null) {
                @Override
        ...
        public SlaveTemplate getSlaveTemplate() {
            return new SlaveTemplate("ami-123", EC2AbstractSlave.TEST_ZONE, null, "default", "foo", InstanceType.M1Large, false, "ttt", Node.Mode.NORMAL, "AMI description", "bar", "bbb", "aaa", "10", "fff", null, "-Xmx1g", false, "subnet-123 subnet-456", null, null, false, "", "", false, "", false, "",null);
        }
    } 
