...
public class TemplateLabelsTest extends HudsonTestCase{
	...
	public void setUp() throws Exception{
		super.setUp();
		SlaveTemplate template = new SlaveTemplate("ami", "foo", "22", InstanceType.M1Large, LABEL1 + " " + LABEL2, "foo ami", "bar", "aaa", "10", "rrr", "fff", "-Xmx1g");
	...
	public void testLabelExpression() throws Exception{
        ...
        public void testEmptyLabel() throws Exception{
            SlaveTemplate temp = new SlaveTemplate("ami", "foo", "22", InstanceType.M1Large, "", "foo ami", "bar", "aaa", "10", "rrr", "fff", "-Xmx1g");
            List<SlaveTemplate> templates = new ArrayList<SlaveTemplate>();
            templates.add(temp);
            ac = new AmazonEC2Cloud(AwsRegion.US_EAST_1, "abc", "def", "ghi", "3", templates);
