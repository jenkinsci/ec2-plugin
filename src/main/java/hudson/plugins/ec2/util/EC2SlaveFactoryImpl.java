...
@Extension
public class EC2SlaveFactoryImpl implements EC2SlaveFactory {
    ...
    @Override
    public EC2SpotSlave createSpotSlave(EC2SlaveConfig.Spot config) throws Descriptor.FormException, IOException {
